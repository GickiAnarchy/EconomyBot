...
class BankCommands(commands.Cog):
    ...
    async def deposit(self, ctx, amount= None):
        ...
        if amount.lower() == "all" or amount.lower() == "max":
            ...
            await ctx.send(f"{self.user.mention} you withdrew {self.wallet_amt} in your wallet")
    ...
    async def leaderboard(self, ctx):
        ...
        em = discord.Embed(
            title=f"Top {self.index} Richest Users - Leaderboard",
